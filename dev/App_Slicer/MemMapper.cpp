...
void file_mapper::Revind ( void ) {

    m_iReadPos = 0;
}

bool file_mapper::Init ( std::string oInFileName ) {
...
uint64_t file_mapper::GetSize ( void ) {

    return m_iFileSize;
}

char file_mapper::operator[] (uint64_t idx) {
...
bool file_mapper::Read ( uint64_t pos, void* buff, uint64_t cnt ) {
...
bool file_mapper::Read ( void* buff, uint64_t cnt ) {
